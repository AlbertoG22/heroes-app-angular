import {
  ...
  Route, RouterStateSnapshot, UrlSegment 
} from '@angular/router';
 
/* No hay necesidad de crear una clase, simplemente definiendo una función 
flecha y exportándola podemos utilizar sus funcionalidades de guard en el app-routing */
